...
public class RequestTrackerDTO {
    ...
    // --- Change Log List ---
    private List<ChangeLogDTO> changeLogs; // Uses the DTO defined previously
    ...
    public RequestTrackerDTO(Long id, Integer duration, String operation, Integer relayNumber, String sensorId, String status, List<ChangeLogDTO> changeLogs) {
        this.id = id;
