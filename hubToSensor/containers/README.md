...
| Steps | Flexibility hub simulator | Flexibility bridge | Column 4 | Column 5 | Column 6 | Column 7 | Column 8 | Column 9 |
|---|---|---|---|---|---|---|---|---|
...
| Build jar | `mvn clean package` | `mvn clean package` | `mvn clean package` | `mvn clean package` | `mvn clean package` | `mvn clean package` | `mvn clean package` | `mvn clean package` |
