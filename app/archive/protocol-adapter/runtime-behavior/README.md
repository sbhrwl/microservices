...
- [Health probing flow](#health-probing-flow)
- [Message bus probe during health check](#message-bus-probe-during-health-check)
- [Threading and execution](#threading-and-execution)
- [Ports and sidecar interaction](#ports-and-sidecar-interaction)
- [Logging and observability](#logging-and-observability)
- [Unknowns and constraints](#unknowns-and-constraints)
