...
- [Ports and config alignment](#ports-and-config-alignment)
- [Health checks at runtime](#health-checks-at-runtime)
- [Run locally with Dapr (JAR)](#run-locally-with-dapr-jar)
- [Notes](#notes)
